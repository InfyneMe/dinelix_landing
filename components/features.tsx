...
const Features = () => {
  const features = [
  {
    ...
    description: 'Process dine-in, takeaway, and online orders instantly with smart billing designed for restaurants of all sizes.',
    stats: '3 sec',
    metric: 'Avg. Bill Time',
    colors: {
  ...
  },
  {
    ...
    description: 'Keep your business safe with role-based access for managers, waiters, and kitchen staff—ensuring smooth and secure workflows.',
    stats: '100%',
  ...
  },
  {
    id: 'team-sync',
    icon: Users,
    title: 'Smart KOT & Team Sync',
    description: 'Auto-send Kitchen Order Tickets (KOT) to chefs and sync updates with waiters in real time—no more missed or delayed orders.',
    stats: '24/7',
    metric: 'Kitchen Sync',
    colors: {
  ...
  },
  {
    ...
    description: 'Track daily sales, taxes (CGST, SGST, VAT), and profit trends with powerful yet simple reports tailored for restaurants.',
    stats: '35%',
    metric: 'Cost Savings',
    colors: {
