  ...
  Simplify restaurant management with DineLix POS. Serve faster, reduce errors, and boost profits with ease.
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © 2025 infyne.in. All rights reserved.
          </p>
          <p className="text-muted-foreground text-sm mt-4 md:mt-0">
            Product by <a href="https://infyne.in" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-indigo-600 hover:underline">infyne.in</a>
          </p>
        </div>
      </div>
    </footer>
