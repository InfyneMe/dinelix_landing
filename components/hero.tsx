...
const Hero = () => {
  ...
  const rotatingWords = ["Effortless", "Seamless", "Limitless"];
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            ...
            Orders, billing, inventory, loyalty — all in one place.
          </motion.p>
          ...
          >
            {mounted && (
              <HeroVideoDialog
                ...
                thumbnailSrc={resolvedTheme === 'dark' ? '/screens/7.png' : '/screens/7.png'}
